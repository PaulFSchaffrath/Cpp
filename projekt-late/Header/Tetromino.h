...
public:
  ...
  [[nodiscard]] std::vector<std::vector<bool>> blocks() const {
    return blocks_;
  }
  ...
  [[nodiscard]] bool canMoveLeft(const Playfield &playfield) const;
  [[nodiscard]] bool canMoveRight(const Playfield &playfield) const;
  [[nodiscard]] bool canMoveDown(const Playfield &playfield) const;
